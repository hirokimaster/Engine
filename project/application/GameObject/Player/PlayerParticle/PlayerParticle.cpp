...
void PlayerParticle::Initialize()
{
	...
	param_.rangeScale.min = Vector3(0.1f, 0.1f, 0.1f);
	param_.rangeScale.max = Vector3(0.2f, 0.2f, 0.2f);
	...
	param_.rangeColor.min = Vector3(1.0f, 0.0f, 0.0f);
	param_.rangeColor.max = Vector3(1.0f, 1.0f, 0.0f);
