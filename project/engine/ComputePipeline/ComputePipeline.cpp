...
void ComputePipeline::CreateRootSignature(Microsoft::WRL::ComPtr<ID3D12Device> device, D3D12_ROOT_SIGNATURE_DESC& descriptionRootSignature, ComputeState& computeState)
{
	// シリアライズしてバイナリにする
...
ComputeState ComputePipeline::CreateSkinning(Microsoft::WRL::ComPtr<ID3D12Device> device, const std::wstring& shaderName)
{
